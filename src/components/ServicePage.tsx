...
const ServicePage: React.FC<ServicePageProps> = ({title, description}) => {
    return (
        <div className="bg-stone-100 py-24 sm:py-32 relative w-full">

            <div className="absolute top-0 left-0 w-full background-container">
            </div>

            <div className="mx-auto max-w-7xl px-6 lg:px-8 mt-80">
